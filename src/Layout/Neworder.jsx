...
<div className="relative w-full flex flex-row justify-center">
  ...
  <button onClick={() => setShowSlip(true)} className="bg-[#169D53] text-white font-bold px-[30px] text-[18px] py-[15px] rounded-lg shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
    Generate Slip
  </button>
</div>
